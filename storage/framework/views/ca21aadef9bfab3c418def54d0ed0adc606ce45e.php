        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <h6 class="mt-3">Silahkan
                    <a href="<?php echo e(route('auth.login')); ?>" style="text-decoration: none">masuk</a> atau
                    <a href="<?php echo e(route('auth.register')); ?>" style="text-decoration: none">daftar</a>
...
</html><?php /**PATH C:\xampp\htdocs\KSI5A-THORIQ-PROJECT\profilKSI\resources\views/home.blade.php ENDPATH**/ ?>