            ...
            <div class="col d-flex justify-content-center">
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahPinjam') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mt-4">
                                <label class="text-secondary mb-2">Tanggal Pinjam</label>
                                <input type="date" class="form-control border border-secondary form-control" name="tanggalPinjam" required value="{{ old('tanggalPinjam') }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary form-control" name="tanggalKembali" required value="{{ old('tanggalKembali') }}">
                                <span class="text-danger">
