            ...
            <div class="col d-flex justify-content-center">
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('postTambahAdmin')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="form-group mt-4">
                                <label class="text-secondary mb-2">Nama Admin</label>
                                <input type="text" class="form-control border border-secondary form-control" name="name" required value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="email" class="form-control border border-secondary form-control" name="email" required value="<?php echo e(old('email')); ?>">
                                <span class="text-danger">
...
</html><?php /**PATH C:\xampp\htdocs\KSI5A-THORIQ-PROJECT\profilKSI\resources\views/admin/tambah.blade.php ENDPATH**/ ?>